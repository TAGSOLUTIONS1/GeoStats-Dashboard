...
const dataPoints = [
  ...
  {
    count: 100,
    label: 'Beds/Baths/Type Combination Counts',
    id: 'property-combo-counts',
    icon: BarChart3,
    isSelected: false,
    isPremium: false,
    description: 'Most common combinations of beds, baths, and property type based on rental listings.',
    source: 'GeoStats Properties',
    Upcoming: false,
  },
  {
    count: 101,
    label: 'Property Type Distribution',
    id: 'property-type-counts',
    icon: Home,
    isSelected: false,
    isPremium: false,
    description: 'Count of listings by property type (e.g., apartment, villa, townhouse).',
    source: 'GeoStats Properties',
    Upcoming: false,
  },
  {
    count: 102,
    label: 'Furnishing Distribution',
    id: 'property-furnishing-counts',
    icon: Building,
    isSelected: false,
    isPremium: false,
    description: 'Distribution of furnished vs unfurnished listings.',
    source: 'GeoStats Properties',
    Upcoming: false,
  },
  {
    count: 103,
    label: 'Avg Rent by Beds and Type',
    id: 'property-avg-rent-beds-type',
    icon: DollarSign,
    isSelected: false,
    isPremium: false,
    description: 'Average rent grouped by number of beds and property type.',
    source: 'GeoStats Properties',
    Upcoming: false,
  },
  {
    count: 104,
    label: 'Avg Rent by Baths and Type',
    id: 'property-avg-rent-baths-type',
    icon: DollarSign,
    isSelected: false,
    isPremium: false,
    description: 'Average rent grouped by number of baths and property type.',
    source: 'GeoStats Properties',
    Upcoming: false,
  },
  {
    count: 105,
    label: 'Avg Rent per Sqft by Location',
    id: 'property-rent-per-sqft-location',
    icon: TrendingUp,
    isSelected: false,
    isPremium: false,
    description: 'Average rent per square foot by location.',
    source: 'GeoStats Properties',
    Upcoming: false,
  },
...
export const dataSections = [
  {
    id: 'dubai-property-insights',
    label: 'Dubai Property Insights',
    isExpanded: false,
    items: [
      getDataPointById('property-combo-counts'),
      getDataPointById('property-type-counts'),
      getDataPointById('property-furnishing-counts'),
      getDataPointById('property-avg-rent-beds-type'),
      getDataPointById('property-avg-rent-baths-type'),
      getDataPointById('property-rent-per-sqft-location'),
    ]
  },
  {
