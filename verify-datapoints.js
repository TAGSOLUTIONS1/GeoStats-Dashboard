...
const layers = [
  ...
  ['population-density', 'src/data/dsc/population-density.json', 'densityPerKm2'],
  ['population-growth-recent', 'src/data/dsc/population-growth-recent.json', 'growth2018to2022Pct'],
  ['schools-per-10k-residents', 'src/data/schools/schools-per-10k.json', 'schoolsPer10k'],
  ['pharmacies-per-10k', 'src/data/dha/pharmacies.json', 'per10kPeople'],
  ['clinics-per-10k', 'src/data/dha/clinics.json', 'per10kPeople'],
  ['hospital-proximity', 'src/data/dha/hospital-proximity.json', 'kmToNearestHospital'],
  ['metro-proximity', 'src/data/osm/metro-proximity.json', 'kmToNearestStation'],
  ['apartment-price-per-sqm', 'src/data/dld/price-per-sqm-by-type.json', 'flatAedPerSqm'],
  ['villa-price-per-sqm', 'src/data/dld/price-per-sqm-by-type.json', 'villaAedPerSqm'],
  ['villa-share-of-sales', 'src/data/dld/price-per-sqm-by-type.json', 'villaSharePct'],
  ...
  ['new-listings-count', 'src/data/bayut/new-listings-count.json', 'newListings30d'],
  ['youth-development-programs', 'src/data/osm/youth-facilities.json', 'per10kPeople'],
...
const cards = [
  ...
  ['average-living-cost', 'src/data/worldbank/cpi-index.json'],
  ['average-healthcare-cost', 'src/data/worldbank/health-expenditure-per-capita.json'],
  ['domestic-migration', 'src/data/worldbank/net-migration.json'],
